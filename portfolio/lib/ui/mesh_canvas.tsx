...
export default function MeshCanvas() {
	...
	useEffect(() => {
		...
		const onPointerMove = (e: PointerEvent) => {
			// Touch has no hover state — a scroll-drag fires pointermove too, and reacting to
			// it fights the resize-settle debounce above instead of being a real interaction.

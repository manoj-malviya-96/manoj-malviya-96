		...
		<Flex direction="col" vAlign="end" gap="lg" className="hero-panel">
			...
			>
				...
				<Typography variant="hero">
					I care about your users <span>as much as your query plans.</span>
				</Typography>
				...
				<Flex direction="row" gap="md" wrap>
					<Link url="#loop" padding="sm" radius="full">
						See how I work →
					</Link>
					<Link url="/resume" padding="sm" radius="full">
						Résumé
					</Link>
				</Flex>
			</Flex>
	...
	return (
		<Flex as="section" direction="col" gap="lg">
			...
			>
				...
				<Link url="/resume" variant="button" color="primary">
					Full history →
				</Link>
			</Flex>
			<StatGrid highlightedProject={FEATURED_WORK[0]} />
		</Flex>
	);
}

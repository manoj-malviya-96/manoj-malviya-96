...
const metadata: ProjectMeta = {
    ...
    tags: ["web", "wasm", "c++", "typescript", "react", "ui/ux", "threejs"] as const,
    effort: "high",
} as const;
    ...
    return (
        ...
        >
            <Typography variant="body">
                ...
                smooth, reactive visuals. Using ThreeJS for rendering means it can handle
                complex effects without breaking a sweat.
            </Typography>
        </ProjectCard>
    );
}
